<template>
  <div>
    <form class="measure center ma1 ds-center" @submit.prevent="placeOrder" v-if="!sucess">
      <LoadingScreen :load="loading" :message="errorMsg"/>
      <div class="mb4">
    ...
    <div v-else>
      <img src="https://media.giphy.com/media/ZZZo9EVpp4KeIiMlT2/giphy.gif"/>
    </div>
  </div>
